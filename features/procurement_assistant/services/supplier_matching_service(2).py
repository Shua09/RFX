...
class SupplierMatchingService:
            ...
            for supplier in suppliers:
                ...
                if match_result['match_score'] >= min_match_score:
                    ...
                    matches.append({
                        ...
                        "access_link": f"{self.base_url}/rfq/suppliers/{encrypted_code}",  # Full URL
                        "match_details": {
    ...
    def generate_email_content(self, mapping_id: int) -> Dict[str, Any]:
        ...
        # Create access link
        access_link = f"{self.base_url}/rfq/suppliers/{encrypted_code}"
        ...
        if matching_items:
            ...
            items_html = "<p>No items matching your product categories were found in this RFQ.</p>"
            items_text = "No items matching your product categories were found in this RFQ."
        ...
        if other_items:
            ...
            <div style="background-color: #fff3cd; border-left: 4px solid #ffc107; padding: 15px; margin: 20px 0;">
                <p style="margin: 0; color: #856404;">
                    ...
                    This RFQ contains <strong>{len(other_items)} other item(s)</strong> that fall outside your registered 
        ...
        This RFQ contains {len(other_items)} other item(s) that fall outside 
        ...
        if data[10] and data[11]:  # total_budget and currency
            try:
                ...
                budget_info = f"""
                <p><strong>Total RFQ Budget:</strong> {data[11]} {budget_formatted}</p>
                <p><em><small>Note: This is the total budget for ALL items in the RFQ, including items that may not match your company's categories.</small></em></p>
                """
                budget_text_line = f"Total RFQ Budget: {data[11]} {budget_formatted} (for all items in the RFQ)"
            except (ValueError, TypeError):
                budget_info = "<p><strong>Total RFQ Budget:</strong> Not specified</p>"
                budget_text_line = "Total RFQ Budget: Not specified"
        else:
            budget_info = "<p><strong>Total RFQ Budget:</strong> Not specified</p>"
            budget_text_line = "Total RFQ Budget: Not specified"
        ...
        <body style="margin: 0; padding: 0; background-color: #0f172a; font-family: 'Outfit', 'Segoe UI', Tahoma, sans-serif;">
            <!-- Outer wrapper -->
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color: #0f172a;">
                <tr>
                    <td align="center" style="padding: 40px 20px;">
                        <!-- Main card -->
                        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%; background-color: #1e293b; border-radius: 16px; border: 1px solid rgba(255,255,255,0.08); overflow: hidden;">
                            
                            <!-- Header with gradient -->
                            <tr>
                                <td style="background: linear-gradient(135deg, #0f2a5e 0%, #1e4d8c 50%, #60a5fa 100%); padding: 32px 36px; text-align: center;">
                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                <table role="presentation" cellpadding="0" cellspacing="0" style="margin-bottom: 16px;">
                                                    <tr>
                                                        <td style="background: rgba(255,255,255,0.15); border-radius: 8px; padding: 8px 12px;">
                                                            <span style="color: #ffffff; font-family: monospace; font-weight: 700; font-size: 14px; letter-spacing: 1px;">FAITE</span>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <h1 style="color: #ffffff; font-size: 24px; font-weight: 700; margin: 0 0 8px 0; letter-spacing: -0.3px;">Request for Quotation</h1>
                                                <p style="color: rgba(255,255,255,0.85); font-size: 16px; margin: 0;">
                                                    RFQ: {data[0]}
                                                    <span style="display: inline-block; background: rgba(255,255,255,0.2); color: #ffffff; padding: 2px 10px; border-radius: 12px; font-size: 12px; font-weight: 600; margin-left: 8px; vertical-align: middle;">{data[3]}% Match</span>
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td style="padding: 32px 36px; color: #e2e8f0;">
                                    <!-- Greeting -->
                                    <p style="font-size: 16px; color: #f1f5f9; margin-bottom: 20px; line-height: 1.5;">
                                        Dear <strong style="color: #ffffff;">{data[5] or data[4] or 'Supplier'}</strong>,
                                    </p>
                                    <p style="font-size: 14px; color: #cbd5e1; margin-bottom: 24px; line-height: 1.6;">
                                        You have been invited to submit a quotation for the above RFQ.
                                        Based on your company's registered products and categories, we've identified the items below as potential matches for your business.
                                    </p>
                                    
                                    <!-- RFQ Summary Card -->
                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); border-radius: 12px; margin-bottom: 24px;">
                                        <tr>
                                            <td style="padding: 20px 24px;">
                                                <p style="font-size: 14px; font-weight: 600; color: #f1f5f9; margin-bottom: 14px;">📋 RFQ Summary</p>
                                                {budget_info}
                                                <p style="font-size: 13px; color: #94a3b8; margin-bottom: 6px;"><strong style="color: #cbd5e1;">Required Date:</strong> {required_date}</p>
                                                <p style="font-size: 13px; color: #94a3b8;"><strong style="color: #cbd5e1;">Delivery Deadline:</strong> {delivery_deadline}</p>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background: linear-gradient(135deg, rgba(15,42,94,0.4) 0%, rgba(30,77,140,0.3) 100%); border: 1px solid rgba(96,165,250,0.2); border-radius: 12px; margin: 24px 0;">
                                        <tr>
                                            <td style="padding: 24px;">
                                                <p style="font-size: 15px; font-weight: 600; color: #f1f5f9; margin-bottom: 16px;">🔐 Two-Step Security Access</p>
                                                
                                                <p style="font-size: 13px; color: #cbd5e1; margin-bottom: 14px;">
                                                    <strong style="color: #60a5fa;">Step 1:</strong> Click the secure link below to access the quotation portal
                                                </p>
                                                
                                                <!-- CTA Button -->
                                                <table role="presentation" cellpadding="0" cellspacing="0" style="margin: 0 auto 18px auto;">
                                                    <tr>
                                                        <td style="border-radius: 24px; background: linear-gradient(135deg, #0f2a5e 0%, #1e4d8c 50%, #60a5fa 100%);">
                                                            <a href="{access_link}" target="_blank" style="display: inline-block; padding: 14px 32px; color: #ffffff; text-decoration: none; font-size: 14px; font-weight: 600; letter-spacing: 0.3px;">Access Quotation Portal →</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                                
                                                <p style="font-size: 13px; color: #cbd5e1; margin-bottom: 10px;">
                                                    <strong style="color: #60a5fa;">Step 2:</strong> Enter your unique passcode when prompted
                                                </p>
                                                
                                                <!-- Passcode display -->
                                                <table role="presentation" cellpadding="0" cellspacing="0" style="margin: 0 auto 12px auto;">
                                                    <tr>
                                                        <td style="background: rgba(0,0,0,0.3); border: 1px solid rgba(96,165,250,0.3); border-radius: 10px; padding: 14px 28px; text-align: center;">
                                                            <span style="font-family: 'Courier New', monospace; font-size: 22px; font-weight: 700; color: #60a5fa; letter-spacing: 4px;">{data[2]}</span>
                                                        </td>
                                                    </tr>
                                                </table>
                                                
                                                <p style="font-size: 12px; color: #f87171; text-align: center;">⚠️ This passcode is unique to your company. Do not share it with others.</p>
                                            </td>
                                        </tr>
                                    </table>
                                    
                                    <!-- What you can do -->
                                    <p style="font-size: 14px; color: #cbd5e1; margin-bottom: 10px;">In the portal, you will be able to:</p>
                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 20px;">
                                        <tr>
                                            <td style="padding: 6px 0; font-size: 13px; color: #94a3b8;">
                                                <span style="color: #60a5fa; margin-right: 8px;">•</span> Review all items (including those that may not match your products)
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 6px 0; font-size: 13px; color: #94a3b8;">
                                                <span style="color: #60a5fa; margin-right: 8px;">•</span> Submit your quotation with pricing per item
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 6px 0; font-size: 13px; color: #94a3b8;">
                                                <span style="color: #60a5fa; margin-right: 8px;">•</span> Specify delivery timelines and warranties
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 6px 0; font-size: 13px; color: #94a3b8;">
                                                <span style="color: #60a5fa; margin-right: 8px;">•</span> Provide your payment terms
                                            </td>
                                        </tr>
                                    </table>
                                    
                                    <!-- Expiry notice -->
                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background: rgba(245,158,11,0.08); border: 1px solid rgba(245,158,11,0.15); border-radius: 8px; margin-bottom: 24px;">
                                        <tr>
                                            <td style="padding: 12px 16px; font-size: 13px; color: #fbbf24;">
                                                ⏰ <strong>This quotation link will expire on {expiry_str}.</strong>
                                            </td>
                                        </tr>
                                    </table>
                                    
                                    <p style="font-size: 14px; color: #94a3b8; margin-bottom: 8px;">If you have any questions regarding this RFQ, please don't hesitate to contact us.</p>
                                    
                                    <p style="font-size: 14px; color: #cbd5e1; margin-top: 20px;">
                                        Best regards,<br>
                                        <strong style="color: #f1f5f9;">{self.sender_name}</strong>
                                    </p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td style="padding: 20px 36px; border-top: 1px solid rgba(255,255,255,0.06); text-align: center;">
                                    <p style="font-size: 11px; color: #475569; margin: 0;">
                                        Powered by FAITE • This is an automated email. Please do not reply directly.
                                    </p>
                                </td>
                            </tr>
    ...
    You have been invited to submit a quotation for RFQ {data[0]}. 
    Your company has a {data[3]}% match score for this RFQ.
    ...
    If you have any questions regarding this RFQ, please don't hesitate to contact us.
